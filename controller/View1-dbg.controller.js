	...
	return t.extend("YY1_PO_DATE_214.YY1_PO_DATE_214.controller.View1", {
		onClear: function (a) {
			...
			onSearch: function () {
				...
				if (porg_srch === " ")
				{
					var msg = "Please enter value for Purchasing Organisation";
					a.show(msg)
				}
				else
				{
		...
		// },
		       var u3 = new sap.ui.model.json.JSONModel;
				// var R3 = "/OPENSAP/sap/opu/odata/sap/API_INFORECORD_PROCESS_SRV/";
				// var p3 = new sap.ui.model.odata.ODataModel(R3, true);
				u3.setData(r);
		...
		var y4 = "/YY1_purchase_date_cpi_214" + "?$filter=(PurchasingOrganization eq " + porg_srch1 + ")";
		debugger; 
						// var data81 = []; 
						// var data81_le = 0; 
						p4.read(y4, {
							...
							success: function (oData, response) {
								...
								for (var u1 = 0; u1 < data_len_in; u1++) {
									...
									r.infopage.push({
									    ...
									    ProductDescription: data_in[u1].ProductDescription,
										ScheduleLineDeliveryDate: date13,
										//StatisticalDeliveryDate: data_in[u1].StatisticalDeliveryDate,
										...
										// PurchasingOrganization : data_in[u1].PurchasingOrganization,
						...
						// u3.setData(r);
						// l.setModel(u3, "inforeport");
						// sap.ui.getCore().setModel(u3, "oModel");
						// this.onDownloadFile()
							u3.setData(r);
		...
		onStat: function () {
			...
			//If we have huge number of records the we will send 40 records in each call 
			       ...
			       for (var b = 0; b < i31; b++) {
			       	...
			       	// PurchasingDocument
						...
						//var ocondrecd = new sap.ui.model.Filter("ConditionRecord", sap.ui.model.FilterOperator.EQ, ConditionRecord);
						var acondrec_i1 = [];
						...
						// var arrfilter_i2 = arr_i2.filter(function (item, index, inputArray) {
						// 	return inputArray.indexOf(item) === index;
						// });

						// //var ocondrecd = new sap.ui.model.Filter("ConditionRecord", sap.ui.model.FilterOperator.EQ, ConditionRecord);
						// var acondrec_i2 = [];
						// for (var q = 0; q < arrfilter_i2.length; q++) {

						// 	acondrec_i2.push(new sap.ui.model.Filter("PurchasingDocumentItem", sap.ui.model.FilterOperator.EQ, arrfilter_i2[q]));

						// }
						// var oFilter_i2 = new sap.ui.model.Filter({
						// 	filters: acondrec_i2,
						// 	and: false
						// });
						...
						var oDataFilter_i1 = new Array(new sap.ui.model.Filter({
			       	  ...
			       	  p31.read(y2, {
							...
							success: function (oData, response){
								...
								// if (global_tab2[o3].PurchaseOrder === data2[o5].PurchasingDocument) {
			...
			// PurchasingDocument
			   ...
			   var acondrec_i3 = [];
				...
				// PurchasingDocumentItem
				// var arrfilter_i4 = arr_i2.filter(function (item, index, inputArray) {
				// 	return inputArray.indexOf(item) === index;
				// }); 
			 //  var acondrec_i4 = [];
				// for (var q = 0; q < arrfilter_i4.length; q++) {

				// 	acondrec_i4.push(new sap.ui.model.Filter("PurchasingDocumentItem", sap.ui.model.FilterOperator.EQ, arrfilter_i4[q]));

				// }
				// 	var oFilter_i4 = new sap.ui.model.Filter({
				// 	filters: acondrec_i4,
				// 	and: false
				// });
